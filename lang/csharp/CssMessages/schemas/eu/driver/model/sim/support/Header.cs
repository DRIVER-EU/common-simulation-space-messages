...
namespace eu.driver.model.sim.support
{
	...
	public partial class Header : ISpecificRecord
	{
		...
		/// <summary>
		/// Optional map of (references to) attachments inside the post: key – unique reference to the attachment (e.g. URI) or complete string-encoded attachment; value – media type of the attachment (e.g. .pdf, .png, .zip)
		/// </summary>
		private IDictionary<string,System.String> _attachments;
		/// <summary>
		...
		/// Optional map of (references to) attachments inside the post: key – unique reference to the attachment (e.g. URI) or complete string-encoded attachment; value – media type of the attachment (e.g. .pdf, .png, .zip)
		/// </summary>
		public IDictionary<string,System.String> attachments
		{
			get
			{
		...
		public virtual void Put(int fieldPos, object fieldValue)
		{
			...
			case 7: this.attachments = (IDictionary<string,System.String>)fieldValue; break;
